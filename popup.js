...
export function showBox(id) {
    ...
    document.getElementById("popupClass").innerText = character.class;
    document.getElementById("popupSpecies").innerText = character.species;
    document.getElementById("popupAge").innerText = character.age;
    document.getElementById("popupOrigin").innerText = character.origin;
